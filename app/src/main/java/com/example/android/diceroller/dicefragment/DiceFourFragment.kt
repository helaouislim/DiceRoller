...
import kotlinx.android.synthetic.main.fragment_dice_four.*

class DiceFourFragment : Fragment(R.layout.fragment_dice_four) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        roll_button.setOnClickListener {
            ...
            dice_image4.setImageResource(DiceObject.rollDiceSix())
        }
    }
}